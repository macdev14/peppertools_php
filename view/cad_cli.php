...
Página de Cadastro <i class="fa fa-user-plus"></i>
...
<div class="container">
	<div class="form-row">
		...
		<div class="col-md-12">
			Codigo do cliente: <i class="fa fa-map"></i>
			<input class="form-control" type="text" name="cod_cli" required>	<br>
		...
		<div class="col-md-4">
			Dt. de Nascimento: <i class="fa fa-calender"></i>
